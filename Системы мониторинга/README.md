...
Минусы:  
  Эффект «собаки лают» (Thundering herd). 10 тысяч агентов одновременно кидают метрики — центральный сервер задыхается.  
...
Плюсы:  
  Единый источник правды. Prometheus сам решит, кого скрейпить и как часто. Если метрики не пришли — виноват либо endpoint, либо сеть.  
...
Минусы:  
  ...
  Не подходит для коротких задач.  
  Проблема производительности. Тянуть метрики с тысяч агентов — это дорого, нужен федеративный сбор (иерархия).  
---
