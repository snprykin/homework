...
Созданы без внешних IP постояная ошибка, даже с выставлением интервалов создания вм. 
...
Так же добавлены интервалы запуска вм

Ссылка на коммит с выполненнием задания:  
https://github.com/snprykin/terraform-homework/commit/1d1fd13ba095f693c87aa5c37b80840b002c85c9
Внес изменения в код добавив переменные
https://github.com/snprykin/terraform-homework/commit/95421c93455d71e0b36f06f2d77ca5bef8ceb0af
